                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 form-floating mb-3 mt-3" id="id_MIMAT0005898">
                            <input type="text" class="form-control" name="MIMAT0005898" id="MIMAT0005898" placeholder="MIMAT0005898" value="{{old('MIMAT0005898')}}" required>
                        ...
                        <div class="col-6 form-floating mb-3 mt-3" id="id_MIMAT0005951">
                            <input type="text" class="form-control" name="MIMAT0005951" id="MIMAT0005951" placeholder="MIMAT0005951" value="{{old('MIMAT0005951')}}" required>
                        ...
                        <div class="col-6 form-floating mb-3 mt-3" id="id_MIMAT0019691">
                            <input type="text" class="form-control" name="MIMAT0019691" id="MIMAT0019691" placeholder="MIMAT0019691" value="{{old('MIMAT0019691')}}" required>
                        ...
                        <div class="col-6 form-floating mb-3 mt-3" id="id_MIMAT0027623">
                            <input type="text" class="form-control" name="MIMAT0027623" id="MIMAT0027623" placeholder="MIMAT0027623" value="{{old('MIMAT0027623')}}" required>
                        ...
                        <div class="col-6 form-floating mb-3 mt-3" id="id_MIMAT0027650">
                            <input type="text" class="form-control" name="MIMAT0027650" id="MIMAT0027650" placeholder="MIMAT0027650" value="{{old('MIMAT0027650')}}" required>
